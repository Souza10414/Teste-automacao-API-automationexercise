...
describe("Registro de usuario", () => {
  ...
  it("Deve registar um usuario com sucesso", () => {
    ...
    registro.selecionarElemento('[data-qa="days"]')(
      dadosUsuario.birthDate.day.toString()
    );
    registro.selecionarElemento('[data-qa="months"]')(
      dadosUsuario.birthDate.month.toString()
    );
    registro.selecionarElemento('[data-qa="years"]')(
      dadosUsuario.birthDate.year.toString()
    );
    ...
    registro.digitarElemento('[data-qa="mobile_number"]')(
      dadosUsuario.mobileNumber
    );

    registro.buscarElemento('[data-qa="create-account"]')(
      "contain",
      "Create Account"
    );
    ...
    registro.buscarElemento('[data-qa="continue-button"]')(
      "contain",
      "Continue"
    );
